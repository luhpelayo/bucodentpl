            ...
            <div class="col-md-4">
                <div>
                    <a href="{{ route ('paciente.index')}}">
                        <img src="{{URL::asset('icons/paciente.png')}}" alt="" class="img-rounded img-thumbnail" />
            ...
            <div class="col-md-4">
                <div>
                    <a href="{{ route ('odontologo.index')}}">
                        <img src="{{URL::asset('icons/dentista.png')}}" alt="" class="img-rounded img-thumbnail" />
            ...
            <div class="col-md-4">
                <div>
                    <a href="{{ route ('parte.index')}}">
                        <img src="{{URL::asset('icons/partes.png')}}" alt="" class="img-rounded img-thumbnail" />
            ...
            <div class="col-md-4">
                <div>
                    <a href="{{ route ('odontograma.index')}}">
                        <img src="{{URL::asset('icons/odonto.png')}}" alt="" class="img-rounded img-thumbnail" />
